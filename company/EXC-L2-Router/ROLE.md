...
2. `STATE_DIR = $HOME/.openfang/slice-state/<mission-slug>/`. Write `plan.md` (slice list +
...
4. Poll with `file_read` on STATE_FILEs. No line in 10 min → re-dispatch same slice once with
