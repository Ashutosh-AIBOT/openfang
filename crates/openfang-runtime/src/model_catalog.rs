...
fn builtin_aliases() -> HashMap<String, String> {
    let pairs = [
        ...
        ("nano-3", "nvidia/nemotron-nano-3-30b-a3b"),
...
fn builtin_models() -> Vec<ModelCatalogEntry> {
    vec![
        ...
        // ══════════════════════════════════════════════════════════════
        // OpenRouter (32) — pass-through models using real upstream IDs
        // ══════════════════════════════════════════════════════════════
        ModelCatalogEntry {
        ...
        ModelCatalogEntry {
            id: "openrouter/inclusionai/ling-3.0-flash-vl:free".into(),
            display_name: "Ling 3.0 Flash VL Free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Smart,
            ...
            supports_vision: true,
            supports_streaming: true,
            aliases: vec!["ling-vl".into()],
        },
        ModelCatalogEntry {
            id: "openrouter/nex-agi/nex-n2.5-mini:free".into(),
            display_name: "Nex N2.5 Mini Free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Smart,
            context_window: 262_144,
            max_output_tokens: 65_536,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["nex-mini".into()],
        },
        ModelCatalogEntry {
            id: "openrouter/nex-agi/nex-n2.5-pro:free".into(),
            display_name: "Nex N2.5 Pro Free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Frontier,
            context_window: 262_144,
            max_output_tokens: 65_536,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["nex-pro".into()],
        },
        ModelCatalogEntry {
            id: "openrouter/thinkingmachines/inkling-small:free".into(),
            display_name: "Inkling Small Free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Smart,
            context_window: 1_048_576,
            max_output_tokens: 65_536,
            ...
            supports_vision: true,
            supports_streaming: true,
            aliases: vec!["inkling-small".into()],
        },
        ModelCatalogEntry {
            id: "openrouter/thinkingmachines/inkling:free".into(),
            display_name: "Inkling Free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Frontier,
            context_window: 1_048_576,
            max_output_tokens: 65_536,
            ...
            supports_vision: true,
            supports_streaming: true,
            aliases: vec!["inkling".into()],
        },
        ModelCatalogEntry {
            id: "openrouter/poolside/laguna-s-2.1:free".into(),
            display_name: "Laguna S 2.1 Free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Smart,
            context_window: 262_144,
            max_output_tokens: 32_768,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["laguna-s".into()],
        },
        ModelCatalogEntry {
            id: "openrouter/cohere/north-mini-code:free".into(),
            display_name: "North Mini Code Free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Smart,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["north-mini".into(), "north-code".into()],
        },
        ModelCatalogEntry {
            id: "openrouter/nvidia/nemotron-3-ultra-550b-a55b:free".into(),
            display_name: "Nemotron 3 Ultra Free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Frontier,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["or-ultra".into()],
        },
        ModelCatalogEntry {
            id: "openrouter/liquid/lfm-2.5-2.6b:free".into(),
            display_name: "LFM 2.5 2.6B Free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Fast,
            context_window: 65_536,
            max_output_tokens: 8_192,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["lfm-2.6b".into()],
        },
        ModelCatalogEntry {
            id: "openrouter/nvidia/nemotron-3.5-lightning:free".into(),
            display_name: "Nemotron 3.5 Lightning Free (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Smart,
            context_window: 1_000_000,
            max_output_tokens: 65_536,
        ...
        ModelCatalogEntry {
            id: "nvidia/nemotron-nano-3-30b-a3b".into(),
            display_name: "Nemotron Nano 3 30B (NVIDIA NIM)".into(),
            provider: "nvidia".into(),
            tier: ModelTier::Smart,
            context_window: 1_000_000,
            max_output_tokens: 16_384,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["nemotron-nano".into(), "nano-3".into()],
        },
        ModelCatalogEntry {
            id: "google/diffusiongemma-26b-a4b-it".into(),
            display_name: "DiffusionGemma 26B (Google NIM)".into(),
            provider: "nvidia".into(),
            tier: ModelTier::Fast,
            context_window: 262_144,
            max_output_tokens: 8_192,
            ...
            aliases: vec![
                "diffusiongemma".into(),
                "diffusion-gemma".into(),
            ],
        },
        ModelCatalogEntry {
            id: "deepseek-ai/deepseek-v4-flash-0731".into(),
            display_name: "DeepSeek V4 Flash (NVIDIA NIM)".into(),
            provider: "nvidia".into(),
            tier: ModelTier::Smart,
            context_window: 1_000_000,
            max_output_tokens: 32_768,
        ...
        ModelCatalogEntry {
            ...
            display_name: "Muse Glimmer 30B (Meta NIM)".into(),
            provider: "nvidia".into(),
            tier: ModelTier::Smart,
            context_window: 131_072,
            max_output_tokens: 16_384,
            ...
            supports_vision: true,
            supports_streaming: true,
            aliases: vec!["glimmer".into(), "muse-glimmer".into()],
        },
        ModelCatalogEntry {
            id: "poolside/laguna-xs-2.1".into(),
            display_name: "Laguna XS 2.1 33B (Poolside NIM)".into(),
            provider: "nvidia".into(),
            tier: ModelTier::Smart,
            context_window: 262_144,
            max_output_tokens: 16_384,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["laguna".into(), "laguna-xs".into()],
        },
        ModelCatalogEntry {
            id: "google/gemma-4-31b-it".into(),
            display_name: "Gemma 4 31B (Google NIM)".into(),
            provider: "nvidia".into(),
            tier: ModelTier::Smart,
            context_window: 262_144,
            max_output_tokens: 16_384,
            ...
            supports_vision: true,
            supports_streaming: true,
            aliases: vec!["gemma-4".into(), "gemma-31b".into()],
        },
        ModelCatalogEntry {
            id: "openai/gpt-oss-20b".into(),
            display_name: "GPT-OSS 20B (NVIDIA NIM)".into(),
            provider: "nvidia".into(),
            tier: ModelTier::Fast,
            context_window: 128_000,
            max_output_tokens: 8_192,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["gpt-oss".into(), "gpt-oss-20b".into()],
        },
        ModelCatalogEntry {
            id: "nvidia/llama-3.1-nemotron-51b-instruct".into(),
            display_name: "Nemotron 51B Instruct (NVIDIA NIM)".into(),
            provider: "nvidia".into(),
            tier: ModelTier::Smart,
            context_window: 128_000,
            max_output_tokens: 4_096,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["nemotron-51b".into()],
        },
        ModelCatalogEntry {
            id: "nvidia/nemotron-3-super-120b-a12b".into(),
            display_name: "Nemotron 3 Super 120B (NVIDIA NIM)".into(),
            provider: "nvidia".into(),
            tier: ModelTier::Frontier,
            context_window: 1_000_000,
            max_output_tokens: 16_384,
        ...
        ModelCatalogEntry {
            ...
            display_name: "Kimi K3 2.8T (Moonshot NIM)".into(),
            provider: "nvidia".into(),
            tier: ModelTier::Frontier,
            context_window: 1_048_576,
            max_output_tokens: 16_384,
            ...
            supports_vision: true,
            supports_streaming: true,
            aliases: vec!["kimi-k3".into(), "kimi".into()],
        },
        ModelCatalogEntry {
            id: "deepseek-ai/deepseek-v4-pro-0813".into(),
            display_name: "DeepSeek V4 Pro (NVIDIA NIM)".into(),
            provider: "nvidia".into(),
            tier: ModelTier::Frontier,
            context_window: 1_000_000,
            max_output_tokens: 32_768,
            ...
            supports_vision: false,
            supports_streaming: true,
            aliases: vec!["deepseek-pro".into(), "deepseek-v4-pro".into()],
        },
        // ══════════════════════════════════════════════════════════════
